          ...
          <div className='header__menu-links'>
            <ul className={burgerMenu === true ? "header__menu-nav active" : "header__menu-nav"}>
              ...
              {dataPartner.map((item, i) => (
                <li key={i}><a onClick={() => setBurgerMenu(false)} href={item.link} className='header__menu-link'>{item.text}</a></li>
              ))}
            ...
            <div><a href="tel:+998935059797" className='header__menu-link header__menu-phone'>+998 93 505 97 97</a></div>
          </div>
